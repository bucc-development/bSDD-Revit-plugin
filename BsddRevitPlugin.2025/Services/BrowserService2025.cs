...
{
    public class BrowserService2025 : IBrowserService
    {
        ...
        public BrowserService2025()
        {
            this.customBrowserControl = new BrowserControl2025();
            this.chromiumWebBrowser = (this.customBrowserControl as BrowserControl2025)?.ChromiumWebBrowser;
        }
        ...
        {
            // Modern CefSharp (Revit 2025+) dropped the bool isAsync overload; bindings are always
            // async-capable. The isAsync parameter is kept for interface compatibility only.
            this.chromiumWebBrowser.JavascriptObjectRepository.Register(name, objectToBind);
        }
